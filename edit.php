    ...
    <div class="col-md-12">
      <form action="edit-process.php" method="post">
        ...
        <div class="form-group">
          ...
          <input type="date" name="date" id="" class="form-control" value="<?php echo $post['DateOfBirth'] ?>">
        </div>
        <div class="form-group">
          <label for="">Giới tính</label><br>
          <input type="radio" id="male" name="gender" value="nam" <?php if (strtolower($post['Gender']) == 'nam') { echo 'checked'; } ?>>
          <label for="male">Nam</label><br>
          <input type="radio" id="female" name="gender" value="nữ" <?php if (strtolower($post['Gender']) == 'nữ') { echo 'checked'; } ?>>
